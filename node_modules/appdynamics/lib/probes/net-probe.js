...
NetProbe.prototype.attach = function(obj) {
  ...
  self.writes = self.agent.metricsManager.createMetric('Network', 'Data sent per minute', 'KB', 'sum');
  self.reads = self.agent.metricsManager.createMetric('Network', 'Data received per minute', 'KB', 'sum');
