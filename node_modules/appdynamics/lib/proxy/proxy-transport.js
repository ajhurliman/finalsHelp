...
ProxyTransport.prototype.control = function(nodeIndex) {
  ...
  self.controlSock.connect('ipc://' + self.agent.proxyCtrlDir + '/0');
...
ProxyTransport.prototype.start = function(dataSocketDirPath, skipInitialConfigRequest) {
  ...
  self.configSocket.connect('ipc://' + dataSocketDirPath + '/0');
  ...
  self.infoSocket.connect('ipc://' + dataSocketDirPath + '/0');
  ...
  self.reportingSocket.connect('ipc://' + dataSocketDirPath + '/1');
