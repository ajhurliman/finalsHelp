...
TransactionRules.prototype.init = function() {
    ...
    self.agent.on('configUpdated', function() {
        ...
        matches = matches.sort(function(r1, r2) { return r2.priority - r1.priority });
...
TransactionRules.matchesRule = function(req, rule, stringMatcher) {
  var matches = true, uri, host, port, pair;
    ...
    port = pair && pair[1] || req.connection.localPort.toString();
    ...
    if ('port'   in rule) matches = matches && stringMatcher.matchString(rule.port, port);
